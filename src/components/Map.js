//imports for all of the dependencies
import {
  MapContainer,
  TileLayer,
  Polygon,
...
function Map(props) {
  ...
  // this is so you can reset to your starting location
  ...
  //this is made to keep to randomly chosen county with in the borders of the state
  return (
    <div id="map-body">
      <MapContainer
        id="map"
